/* Кога ги дефинираме функциите copy1 и copy2 во p09_13.c, првиот аргумент мора да е доволно голем за да ги добие вредностите на вториот аргумент.
 * Што тоа значи?
 * Ако првиот аргумент не е доволно голем нема да може да ги добие сите вредности од вториот аргумент.
 * Program p09_13.c
